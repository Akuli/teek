...
latex_documents = [
    (master_doc, 'Tkinder.tex', 'Tkinder Documentation',
     'Akuli', 'manual'),
]
...
man_pages = [
    (master_doc, 'tkinder', 'Tkinder Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Tkinder', 'Tkinder Documentation',
     author, 'Tkinder', 'One line description of project.',
     'Miscellaneous'),
]
